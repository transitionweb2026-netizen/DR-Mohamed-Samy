...
const SOCIAL_LINKS = [
  ...
  },
  {
    id: "instagram",
    href: "#",
    path: "M12 2.16c3.2 0 3.58.01 4.85.07 3.25.15 4.77 1.69 4.92 4.92.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.15 3.23-1.66 4.77-4.92 4.92-1.27.06-1.64.07-4.85.07s-3.58-.01-4.85-.07c-3.26-.15-4.77-1.7-4.92-4.92-.06-1.27-.07-1.64-.07-4.85s.02-3.58.07-4.85c.15-3.23 1.67-4.77 4.92-4.92 1.27-.06 1.65-.07 4.85-.07M12 0C8.74 0 8.33.01 7.05.07 2.7.27.27 2.69.07 7.05.01 8.33 0 8.74 0 12s.01 3.67.07 4.95c.2 4.36 2.62 6.78 6.98 6.98 1.28.06 1.69.07 4.95.07s3.67-.01 4.95-.07c4.35-.2 6.78-2.62 6.98-6.98.06-1.28.07-1.69.07-4.95s-.01-3.67-.07-4.95C23.72 2.7 21.3.28 16.95.07 15.67.01 15.26 0 12 0zm0 5.84a6.16 6.16 0 100 12.32A6.16 6.16 0 0012 5.84zM12 16a4 4 0 110-8 4 4 0 010 8zm6.41-11.85a1.44 1.44 0 100 2.88 1.44 1.44 0 000-2.88z",
  },
  {
    id: "facebook",
    href: "#",
...
// Unified social/contact pill used at the bottom-right corner of every
// hero section. Replaces the 6 different bespoke icon bars each page used
// to render (different icon sets, different positions -- some vertical,
// some inline) with a single shared component: phone number + divider +
// social icons, in the site's own glass/teal styling.
    ...
    <div className="absolute bottom-5 end-5 md:bottom-8 md:end-8 z-20 glass-panel rounded-full py-2 ps-5 pe-2 md:ps-6 md:pe-3 flex items-center gap-3 md:gap-4">
      ...
      <div className="flex items-center gap-2">
        {SOCIAL_LINKS.map((social) => (
          <a
            key={social.id}
            aria-label={t("followUsOn", { platform: social.id })}
