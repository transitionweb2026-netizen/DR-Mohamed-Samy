...
export const homeSections: SectionDef[] = [
  ...
  section(
    ...
    "Latest Videos",
    {
      ...
      title: "text",
      cta: "button",
      items: { type: "array", itemSchema: { image: "image", tag: "text", title: "text" } },
    },
    {
      ...
      items: [
        { id: "liverTransplantProcess", image: image(IMG.liverTransplantProcess, text("home.videos.items.liverTransplantProcess.title")), tag: text("home.videos.items.liverTransplantProcess.tag"), title: text("home.videos.items.liverTransplantProcess.title") },
        { id: "patientJourney", image: image(IMG.patientJourney, text("home.videos.items.patientJourney.title")), tag: text("home.videos.items.patientJourney.tag"), title: text("home.videos.items.patientJourney.title") },
        { id: "advancedRobotics", image: image(IMG.advancedRobotics, text("home.videos.items.advancedRobotics.title")), tag: text("home.videos.items.advancedRobotics.tag"), title: text("home.videos.items.advancedRobotics.title") },
      ],
    },
  ),
  section(
